...
public final class ApiUserRepo implements com.egifix.madarlogin.data.repo.ApiUserHelper {
    private final com.egifix.madarlogin.data.db.dao.UserDao userDao = null;
    
    @javax.inject.Inject()
    public ApiUserRepo(@org.jetbrains.annotations.NotNull()
    com.egifix.madarlogin.data.db.dao.UserDao userDao) {
        super();
    }
